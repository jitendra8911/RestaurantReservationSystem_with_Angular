...
create table reservationList(confirmationCode int not null AUTO_INCREMENT,tableId int,partyDate date not null,partyTime time not null,partySize int not null,booking_status varchar(30),firstName varchar(100),lastName varchar(100),phone char(12),primary key(confirmationCode));
...
create table restaurantWebSettings(autoAssign bool not null,openTime time not null,closingTime time not null,openDays varchar(100),closingDays varchar(100));
...
insert into reservationList values(null,null,'2015-08-10','12:00',5,'confirmed','Jitendra','Malakalapalli','918-287-8750');
insert into reservationList values(null,null,'2015-08-10','18:00',2,'confirmed','Jitendra','Malakalapalli','918-287-8750');
insert into reservationList values(null,3,'2015-08-10','15:00',6,'confirmed','Gopi','Malakalapalli','918-260-5545');
insert into reservationList values(null,null,'2015-08-10','12:00',5,'waiting','Raghav','Sriram','918-212-2323');
insert into reservationList values(null,null,'2015-08-10','13:00',5,'waiting','Pavan','Ande','918-287-8752');
insert into reservationList values(null,10,'2015-08-10','17:00',10,'confirmed','Rakesh','Ega','918-287-8756');
insert into reservationList values(null,10,'2015-08-10','15:00',10,'confirmed','Jitendra','Malakalapalli','918-287-8750');
insert into reservationList values(null,3,'2015-08-10','16:00',8,'confirmed','Charan','Chalichama','918-287-8759');
insert into reservationList values(null,null,'2015-08-10','15:20',6,'confirmed','Sreejan','Alapati','918-287-8759');
insert into reservationList values(null,null,'2015-08-10','17:20',6,'confirmed','Johnson','Mithcell','918-287-8780');
insert into reservationList values(null,9,'2015-08-10','17:40',7,'confirmed','Michael','Clarke','918-287-8781');
insert into reservationList values(null,1,'2015-08-10','16:30',5,'confirmed','Steven','Waugh','918-287-7219');
insert into reservationList values(null,1,'2015-08-10','20:30',5,'confirmed','Steven','Waugh','918-287-7219');
